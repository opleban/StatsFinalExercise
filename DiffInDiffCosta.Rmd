...
# LOAD WDI COUNTRIES
wdi.countries <- read_excel("~/desktop/stats/final_exercise/Country.xlsx")
```
...
wdi.did <- filter(wdi.selected, (Country_Name =="Costa Rica" | Country_Name=="Peru") & (Year >= 1986 & Year <= 2002))

wdi.more <- filter(wdi.selected, (Country_Name =="Costa Rica" | Country_Name=="Peru" | Country_Name=="Panama" | Country_Name=="Guatemala" | Country_Name=="Honduras" | Country_Name=="Dominican Republic" | Country_Name=="Ecuador" | Country_Name=="Venezuela, RB" | Country_Name=="Colombia" | Country_Name=="Paraguay") & (Year >= 1986 & Year <= 2002))
