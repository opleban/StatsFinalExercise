...
wdi.more <- filter(wdi.selected, (Country_Name =="Costa Rica" | Country_Name=="Peru" | Country_Name=="Panama" | Country_Name=="Guatemala" | Country_Name=="Honduras" | Country_Name=="Dominican Republic" | Country_Name=="Ecuador" | Country_Name=="Venezuela, RB" | Country_Name=="Colombia" | Country_Name=="Paraguay") & (Year >= 1982 & Year <= 2010))
